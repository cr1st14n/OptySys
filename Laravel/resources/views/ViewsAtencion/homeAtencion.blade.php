...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">registrar atencion</li>
                    </ul>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group ">
                                        <input id="atenCI" type="text" class="form-control" value="" placeholder="CI / NIT" oninput="validar('atenCI')" onkeyup="buscarCI('atenCI')" required pattern="[0-9]{1,10}">
    ...
    <div class="modal fade" id="ModalCreateAtencion" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-round waves-effect" id="btnRegistrarAtencion">Registrar</button>
                </div>
            </div>
        </div>
    </div>
...
@endsection
@section('scrypt')
    <script src="{{asset('AsincronoJS/atencion.js')}}"></script>
@endsection